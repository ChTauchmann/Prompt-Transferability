...
class RobertaEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None, **kwargs):
        ...
        if inputs_embeds is None:
            ...
            ########check train cross model prompt --> Enter here or not ?!
            ...
            #print(mask_prompt_emb.shape)
            #print(prompt_emb.data.shape)
            #exit()
    ...
    def forward(
        ...
        **kwargs
        ...
        if not return_dict:
            output = (prediction_scores,) + outputs[2:]
            if prompt_emb_output == True:
                return ((masked_lm_loss,) + output) if masked_lm_loss is not None else output, prompt_emb
            else:
